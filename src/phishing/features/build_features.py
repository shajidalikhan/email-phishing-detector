...
from src.phishing.features.extract_meta import get_url_count, get_text_length, get_special_char_ratio, get_keyword_flags
from src.phishing.features.vectorize_text import vectorize_data
from src.phishing.features.combine_features import combine_features
...
if __name__ == "__main__":
    ...
    input_csv = os.path.join(base_dir, 'data', 'phishing', 'phishing_dataset_final.csv')
    
    # Ensure processed directory exists
    processed_dir = os.path.join(base_dir, 'data', 'phishing', 'processed')
    ...
    # 2. Run Vectorization
    models_dir = os.path.join(base_dir, 'models', 'phishing')
