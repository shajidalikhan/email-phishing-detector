...
def main(args):
    ...
    data_path = args.data_path if args.data_path else os.path.join(project_root, 'data', 'phishing', 'external', 'Phishing_Email.csv')
    model_save_path = args.output_dir if args.output_dir else os.path.join(project_root, 'models', 'phishing', 'bert')
    ...
    training_args = TrainingArguments(
        output_dir=os.path.join(project_root, 'models', 'phishing', 'bert', 'results'),
        num_train_epochs=args.epochs,
        per_device_train_batch_size=args.batch_size,
        per_device_eval_batch_size=args.batch_size * 2,
        warmup_steps=100,
        weight_decay=0.01,
        logging_dir=os.path.join(project_root, 'models', 'phishing', 'bert', 'logs'),
        logging_steps=10,
    ...
    zip_path = os.path.join(project_root, 'models', 'phishing', 'bert_model_export')
